...
import SortingVisualizer from '@/components/visualizations/algorithms/SortingVisualizer';
import GraphVisualizer from '@/components/visualizations/algorithms/GraphVisualizer';
import TreeVisualizer from '@/components/visualizations/algorithms/TreeVisualizer';
...
export default function AlgorithmsUnitPage() {
  const params = useParams();
  const unitId = params.unit as string;

  const course = getCourse('6-1210');
  const unit = getUnit('6-1210', unitId);
