...
import ComplexityChart from '@/components/visualizations/complexity/ComplexityChart';
import OptimizationPlot from '@/components/visualizations/complexity/OptimizationPlot';
...
export default function CompThinkingUnitPage() {
  const params = useParams();
  const unitId = params.unit as string;

  const course = getCourse('6-100b');
  const unit = getUnit('6-100b', unitId);
